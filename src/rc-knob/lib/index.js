...
var onMove = function onMove(_ref) {
  ...
  var value = getValueFromPercentage(
    _objectSpread({}, state, {
...
var onChangeByStep = function onChangeByStep(_ref2) {
  ...
  return _objectSpread({}, state, {
    value: value,
    percentage: getPercentageFromValue(
      _objectSpread({}, state, {
        value: value,
      })
    ),
...
var Pointer = function Pointer(_ref) {
  ...
  return React__default.createElement(
    ...
    {
      transform: "\n        rotate("
        .concat(angleOffset + angleRange * percentage, " ")
        .concat(center, " ")
        .concat(center, ")\n        translate( ")
        .concat(center - width / 2, " ")
        .concat(center - radius - height, ")\n        "),
    },
    children &&
...
var Scale = function Scale(_ref4) {
  var angleRange = _ref4.angleRange,
    ...
    activeClassName =
      _ref4$activeClassName === void 0 ? className : _ref4$activeClassName,
    fn = _ref4.fn,
...
var Knob = function Knob(_ref2) {
  ...
  return React__default.createElement(
    "div",
    {
      ...
      style: {
        outline: "none",
        //THIS IS WHAT DETERMINES WHERE THE DIAL SHOWS UP
